                            ...
                            <div class="card-body">
                                ...
                                if ($result === FALSE) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<a href="delete_testimonial.php?id=' . $row['testimonial_id'] . '" class="btn btn-sm btn-square btn-neutral text-danger-hover" onclick="return confirm(\'Are you sure you want to delete this testimonial?\');">
